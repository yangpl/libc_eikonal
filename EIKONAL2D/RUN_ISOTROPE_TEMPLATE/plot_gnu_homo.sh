...
echo "set output 'MAP_HOMO.jpg'" >>dessin.gnu
echo "set cbrange [0.0:0.7]" >>dessin.gnu
...
echo "unset key" >>dessin.gnu
echo "set term jpeg" >>dessin.gnu
echo "set output 'CONTOUR_HOMO.jpg'" >>dessin.gnu
echo "set contour base" >>dessin.gnu
echo "set cntrparam level incremental 0.,0.05,0.7" >>dessin.gnu
echo "set xrange [0:$1]" >>dessin.gnu
echo "set yrange [0:$2]" >>dessin.gnu
...
echo particular homogeneous case: 501 and 501 
echo @@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@
exit 0
fi
fi
